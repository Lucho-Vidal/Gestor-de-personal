                    ...
                    <tr v-if="registro.viewDetail">
                        <td colspan="12">
                            <div class="row" v-if="registro.novedad">
                                <h6 class="col-2">
                                    Novedad:{{ registro.novedad._id }}
                                </h6>
                                <p class="col-3">
                                    Personal:{{
                                        registro.novedad.apellido +
                                        " " +
                                        registro.novedad.nombres
                                    }}
                                </p>
                                <p class="col-3">
                                ...
                                <p class="col-3">
                                    Baja:{{ registro.novedad.fechaBaja }} Alta:
                                    {{ registro.novedad.fechaAlta }}
                                </p>
                                <p class="col-3">
                            ...
                            <div class="row" v-if="registro.personal">
                                ...
                                <p class="col-3">
                                    Personal:{{
                                        registro.personal.apellido +
                                        " " +
                                        registro.personal.nombres
                                    }}
                                </p>
                                <p class="col-3">
                                ...
                                <p class="col-3">
                                    Especialidad:{{
                                        registro.personal.especialidad
                                    }}
                                    Franco: {{ registro.personal.franco }}
                                </p>
                                <p class="col-3">
                            ...
                            <div class="row" v-if="registro.turno">
                                ...
                                <p class="col-3">
                                    Circular:{{
                                        registro.turno.circular
                                    }}
                                    Itinerario: {{ registro.turno.itinerario }}
                                </p>
                                <p class="col-3">
    ...
    methods: {
        ...
        ordenarRegistros() {
            this.registros.sort((a, b) =>
                new Date(b.fecha).getTime > new Date(a.fecha).getTime ? 1 : -1
            );
        },
