...
export const getPersonales = async ():Promise<AxiosResponse<IPersonal[]>> => await axios.get("/Personal");

export const getPersonal = async (id: string): Promise<AxiosResponse<IPersonal>> =>
